...
public class DepthFirstTraversalIterativeTest {

    private DepthFirstTraversalIterative classUnderTest;

    @BeforeEach
    public void setUp() {
        this.classUnderTest = new DepthFirstTraversalIterative();
    }
    ...
    public void testTraversalNonCyclic() {
        ...
        assertArrayEquals(new int[] {0, 2, 4, 3, 1}, results);
    }
